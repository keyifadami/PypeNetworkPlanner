...
from gui.design.drawing_panel import DrawingPanel
from gui.TabPanels import NodeTabPanel as NodeTabPanel
from gui.TabPanels import PipeTabPanel as PipeTabPanel
from gui.TabPanels import ValveTabPanel as ValveTabPanel
...
class RibbonFrame(wx.Frame):
    ...
    def onFitScreenButtonClick(self, event):
        self.drawing_canvas.Canvas.ZoomToBB()
        return
